...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-OXZBHKXL.js").then((m) => m.LoginComponent)
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-WEMG64Q6.js").then((m) => m.DashboardComponent),
    canActivate: [authGuard]
  },
  {
    path: "lists/new",
    loadComponent: () => import("./chunk-UAA3Q2HO.js").then((m) => m.ListCreateComponent),
    canActivate: [authGuard]
  },
  {
    path: "lists/:id/edit",
  ...
  {
    path: "lists/:id",
    loadComponent: () => import("./chunk-V6ET5XEJ.js").then((m) => m.ListDetailComponent),
    canActivate: [authGuard]
  },
  {
    path: "**",
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(App, { className: "App", filePath: "src/main.ts", lineNumber: 23 });
})();
